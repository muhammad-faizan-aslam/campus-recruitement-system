...
class STUDENTSIGNUP extends Component {
  ...
  .then((res)=>{
        this.props.checkLogin('studentMainPage')
        console.log('res',res)
       
      let db = fire.database();
      db.ref('Users/'+res.user.uid)
      .set({
        UserName : username , UserEmail : email , UserPassword : password , UserId : res.user.uid , Type : 'student' , JoiningTime : res.user.metadata.creationTime
      })  
    ...
    return (
      ...
      <div className="App">
            ...
            <form  style={{maxwidth:500,margin:'auto'}}   onSubmit={this.signup}  >
                  ...
                  <NavLink to="/studentSignin"> LOGIN  </NavLink>
                </span>
                  </div>
            </div>
